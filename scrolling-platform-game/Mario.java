...
public class Mario extends Actor
{
    ...
    // BG SOUND
    private GreenfootSound bgSound = new GreenfootSound("Super Bomberman - Level 1.mp3");
    /**
     * Constructor
     * 
    ...
    Mario(int startingX)
    {
        ...
        // Set image
        setImage("Mario-jumpdownright.png");
        ...
        {
            walkingRightImages[i] = new GreenfootImage("Mario-walk-right0.png");
    ...
    private void checkKeys()
    {
        ...
        if (Greenfoot.isKeyDown("space") && !isGameOver)
        {
            ...
            {
                jump();
                Greenfoot.playSound("SE_JumpDaiKaiten.wav");
            }
        }
    }
    ...
    public void jump()
    {
        ...
        {
            setImage("Mario-jumpupright.png");
        }
    ...
    public void moveRight()
    {
        ...
        else if (currentScrollableWorldXPosition + deltaX * 2 > world.SCROLLABLE_WIDTH - world.HALF_VISIBLE_WIDTH)
        {
            ...
            else
            {
                isGameOver = true;
                world.setGameOver();
                Greenfoot.playSound("Super Bomberman - Stage Complete.mp3");
                bgSound.stop();
